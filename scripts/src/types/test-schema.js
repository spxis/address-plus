...
export function isAddressFormattingTestCase(testCase) {
  return (
    ...
    testCase.options &&
    ("format" in testCase.options || "case" in testCase.options || "abbreviate" in testCase.options)
  );
}
...
export function isCleanAddressTestCase(testCase) {
  return (
    ...
    testCase.options !== undefined &&
    testCase.options &&
    ("removeExtraSpaces" in testCase.options || "standardizeCase" in testCase.options)
  );
}
