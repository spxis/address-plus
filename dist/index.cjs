...
__export(index_exports, {
  ...
  CANADIAN_POSTAL_LIBERAL_PATTERN: () => CANADIAN_POSTAL_LIBERAL_PATTERN,
  ...
  STREET_TYPE_PROPER_CASE: () => STREET_TYPE_PROPER_CASE,
  UNIT_TYPE_KEYWORDS: () => UNIT_TYPE_KEYWORDS,
  UNIT_TYPE_NUMBER_PATTERN: () => UNIT_TYPE_NUMBER_PATTERN,
...
var import_fast_levenshtein = __toESM(require("fast-levenshtein"), 1);
...
function normalizeRegion(input) {
  ...
  for (const region of REGIONS) {
    const dist = import_fast_levenshtein.default.get(clean, region.name.toLowerCase());
