...
exports.parseLocationSimple = parseLocationSimple;
 ...
 */
function parseLocationSimple(address, options = {}) {
    ...
    if (streetPart) {
        ...
        const dirPattern = buildPattern(data_1.DIRECTIONAL_MAP);
        ...
        if (typeIndex >= 0) {
            ...
            if (typeIndex + 1 < streetWords.length) {
                ...
                if (dirPattern.test(suffixCandidate)) {
                    result.suffix = data_1.DIRECTIONAL_MAP[suffixCandidate.toLowerCase()];
